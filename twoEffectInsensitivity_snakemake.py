...
rule slim_simulate_withsegregating:
  ...
  output:
    fixedSmall="{prefix}/PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_cost{cost}_rep{rep}.fixedSmall",
    fixedLarge="{prefix}/PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_cost{cost}_rep{rep}.fixedLarge",
    meanSmall="{prefix}/PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_cost{cost}_rep{rep}.meanSmall",
    meanLarge="{prefix}/PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_cost{cost}_rep{rep}.meanLarge",
    ...
    deltaRSmall="{prefix}/PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_cost{cost}_rep{rep}.deltaRSmall",
    deltaRLarge="{prefix}/PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_cost{cost}_rep{rep}.deltaRLarge",
    tmp="{prefix}/PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_cost{cost}_rep{rep}.tmp"
  params:
    ...
    mem="4Gb"
  log:
    '"{prefix}/logs/PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_cost{cost}_rep{rep}.log",'
  shell:
...
rule result_combined: 
   input:
     fixedSmall=expand("{{prefix}}/PopSize{{N}}_aL{{alphaLarge}}_rhot{{rhot}}_envSD{{envSD}}_cost{{cost}}_rep{rep}.fixedSmall", rep=rep),
     fixedLarge=expand("{{prefix}}/PopSize{{N}}_aL{{alphaLarge}}_rhot{{rhot}}_envSD{{envSD}}_cost{{cost}}_rep{rep}.fixedLarge", rep=rep),
     meanSmall=expand("{{prefix}}/PopSize{{N}}_aL{{alphaLarge}}_rhot{{rhot}}_envSD{{envSD}}_cost{{cost}}_rep{rep}.meanSmall", rep=rep),
     meanLarge=expand("{{prefix}}/PopSize{{N}}_aL{{alphaLarge}}_rhot{{rhot}}_envSD{{envSD}}_cost{{cost}}_rep{rep}.meanLarge", rep=rep),
     ...
     nSegSmall=expand("{{prefix}}/PopSize{{N}}_aL{{alphaLarge}}_rhot{{rhot}}_envSD{{envSD}}_cost{{cost}}_rep{rep}.nSegSmall", rep=rep),
     nSegLarge=expand("{{prefix}}/PopSize{{N}}_aL{{alphaLarge}}_rhot{{rhot}}_envSD{{envSD}}_cost{{cost}}_rep{rep}.nSegLarge", rep=rep)
   output:
     fixedSmall="{prefix}/PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_cost{cost}_all.fixedSmall",
     fixedLarge="{prefix}/PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_cost{cost}_all.fixedLarge",
     meanSmall="{prefix}/PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_cost{cost}_all.meanSmall",
     meanLarge="{prefix}/PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_cost{cost}_all.meanLarge",
     ...
     nSegSmall="{prefix}/PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_cost{cost}_all.nSegSmall",
     nSegLarge="{prefix}/PopSize{N}_aL{alphaLarge}_rhot{rhot}_envSD{envSD}_cost{cost}_all.nSegLarge"
   shell: 
