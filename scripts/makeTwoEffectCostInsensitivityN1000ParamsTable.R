...
my.table <- get(load("twoEffectCostInsensitivityN1000PreliminaryParamsTable.Rdata"))
...
save(c.table,file="twoEffectCostInsensitivityN1000ParamsTable.Rdata")
write.table(out.table, "twoEffectCostInsensitivityN1000ParamsTable.txt", col.names=T, row.names=F, quote=F)
