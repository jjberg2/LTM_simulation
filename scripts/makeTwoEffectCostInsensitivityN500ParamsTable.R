...
my.table <- get(load("twoEffectCostInsensitivityN500PreliminaryParamsTable.Rdata"))
...
save(c.table,file="twoEffectCostInsensitivityN500ParamsTable.Rdata")
write.table(out.table, "twoEffectCostInsensitivityN500ParamsTable.txt", col.names=T, row.names=F, quote=F)
