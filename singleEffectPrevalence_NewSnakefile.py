...
# rule makeSingleEffectParamTable:
#   input:
...
# rule allSingleEffect:
#   input:
#     "singleEffectInsensitivityN1000ResultsTable.Rdata",
#     "singleEffectVarianceInsensResultsTable.Rdata"
...
#    input:
#      fixed=expand("{{paramsName}}/PopSize{{N}}_LiaSize{{liaSizes}}_rho{{rhos}}_cost{{cost}}_envsd{{envsd}}_rep{rep}.fixed", rep=rep_small),
#      mean=expand("{{paramsName}}/PopSize{{N}}_LiaSize{{liaSizes}}_rho{{rhos}}_cost{{cost}}_envsd{{envsd}}_rep{rep}.mean", rep=rep_small),
#      h2=expand("{{paramsName}}/PopSize{{N}}_LiaSize{{liaSizes}}_rho{{rhos}}_cost{{cost}}_envsd{{envsd}}_rep{rep}.h2", rep=rep_small),
#      prev=expand("{{paramsName}}/PopSize{{N}}_LiaSize{{liaSizes}}_rho{{rhos}}_cost{{cost}}_envsd{{envsd}}_rep{rep}.prev", rep=rep_small),
#      genVar=expand("{{paramsName}}/PopSize{{N}}_LiaSize{{liaSizes}}_rho{{rhos}}_cost{{cost}}_envsd{{envsd}}_rep{rep}.genVar", rep=rep_small),
#      nSeg=expand("{{paramsName}}/PopSize{{N}}_LiaSize{{liaSizes}}_rho{{rhos}}_cost{{cost}}_envsd{{envsd}}_rep{rep}.nSeg", rep=rep_small),
#      deltaR=expand("{{paramsName}}/PopSize{{N}}_LiaSize{{liaSizes}}_rho{{rhos}}_cost{{cost}}_envsd{{envsd}}_rep{rep}.deltaR", rep=rep_small),
#      riskFreq=expand("{{paramsName}}/PopSize{{N}}_LiaSize{{liaSizes}}_rho{{rhos}}_cost{{cost}}_envsd{{envsd}}_rep{rep}.riskFreq", rep=rep_small),
#      derFreq=expand("{{paramsName}}/PopSize{{N}}_LiaSize{{liaSizes}}_rho{{rhos}}_cost{{cost}}_envsd{{envsd}}_rep{rep}.derFreq", rep=rep_small),
#      siteVar=expand("{{paramsName}}/PopSize{{N}}_LiaSize{{liaSizes}}_rho{{rhos}}_cost{{cost}}_envsd{{envsd}}_rep{rep}.siteVar", rep=rep_small),
#    params:
#      time="36:00:00",
#      partition="broadwl",
#      mem="2Gb"
