...
rule all:
  input:
    ...
    expand("largeEffectInsensitivity/all/PopSize{N}_LiaSize{liaSizes}_rho{rhos}_cost{cost}_envsd{envsd}_all.fixed",zip, N=N, liaSizes=liaSizes, rhos=rhos, cost=cost, envsd=envsd),
